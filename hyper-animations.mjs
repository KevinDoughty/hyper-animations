import { boxhandler, dimensionhandler } from 'box-handler';
import 'color-handler';
import 'dimension-handler';
import 'font-weight-handler';
import 'number-handler';
import 'position-handler';
import 'shadow-handler';
import 'shape-handler';
import 'transform-handler';
import 'visibility-handler';
...
var boxType = {
	parse: boxhandler[0][0],
	merge: boxhandler[0][1],
	properties: boxhandler[0][2]
